...
1.0 behavior change: tags produced here are written with origin='machine'
(pipeline.db.replace_machine_tags) and never touch origin='human' rows —
see db.py for the enforcement. This module only computes the raw
category/confidence pairs; it doesn't know about origin at all.
"""
